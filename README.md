...
ResearchGPT retrieves research papers using semantic search powered by Sentence Transformer embeddings and FAISS vector indexing.
...
Research papers can be organized into custom collections.
